---
title: "Compec VB R Workshop - Fall 2023"
author: "Onur Keleş"
...
Special thanks to my friend [Ömer
Bayraklı](https://twitter.com/omer_bayrakli) for his help with the
...
-   **December 8** - Inferential statistics (linear regression) and
    RMarkdown

-   **December 15** - Machine learning and Twitter data analysis

**Note:** This is a beginner course! If you already know advanced
statistics or R, this workshop will not be for you!

**Note2:** There will be mini exercises (which could be done in the
second hour of the workshop). To get a certificate by Compec, I will ask
you to open up a Github repository and upload your solutions/notes
there. Optionally, you can get a final hands-on data science project
which can be useful for your future job applications. After today's
workshop, I will share an Google sheets with you and you can enter your
Github repo link there. You can also collaborate on exercises. If you
have not used Github before, don't worry. I'll send you a video
explaining how you can open an account and push your code to a
repository.
